...
INSERT INTO events (`id_event`,`titre`,`date_event`,`description_event`,`min_participant`,`max_participant`,`id_adresse`,`url_image`,`pseudo_contributor`) VALUES
(NULL,"Évenement 1","2019-11-07 17:00:00","description de l'évenement 1",5,1000,2,NULL,"Y2ssam"),
(NULL,"Évenement 2","2019-12-06 18:00:00","description de l'évenement 2",100,10000,1,NULL,"chakibReds");
