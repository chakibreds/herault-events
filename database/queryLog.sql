...
INSERT INTO events (`id_event`,`titre`,`date_event`,`description_event`,`min_participant`,`max_participant`,`id_adresse`,`url_image`,`pseudo_contributor`,`theme`) VALUES (NULL,'Soutenance projet Web','2019\-12\-17 09\:00\:00','Rah tetbetchek','2','2','4','1105133\-skyrim\-logo\.jpg','Y2ssam');

INSERT INTO adresse VALUES(NULL,'15','Collin','Montpellier','France','34000','');
